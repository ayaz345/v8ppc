...
output = {
    ...
    'run_count_arm':
    3,
    'run_count_android_arm':
    1,
    'run_count_android_arm64':
    3,
    'timeout_arm':
    120,
    'timeout_android_arm':
    180,
    'timeout_android_arm64':
    120,
    'units':
    'ms',
    'resources': ([
    ...
    ] + [f'test/simdjs/data/src/benchmarks/{t}.js' for t in tests]),
    'flags': ['test/simdjs/harness-adapt.js'],
    'path': ['../../'],
    'tests': [{
        'name': test,
        'main': 'test/simdjs/harness-finish.js',
        'flags': [f'test/simdjs/data/src/benchmarks/{test}.js'],
